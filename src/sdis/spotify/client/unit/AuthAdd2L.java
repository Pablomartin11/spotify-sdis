...
public class AuthAdd2L {
    ...
    public static void main(String[] args) throws java.io.IOException {
        if (args.length != 5) {
            System.out.println("Use:\njava protocol.cliente.XAUTH host user password and then java protocol.cliente.Add2L clave valor");
            System.exit(-1);
        }
        ...
        try {
            ...
            pruebaPeticionRespuesta(new MensajeProtocolo(Primitiva.ADD2L, key, value));
